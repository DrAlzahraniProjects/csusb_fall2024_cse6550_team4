...
RUN mkdir -p /root/.jupyter && \
    ...
    echo "c.NotebookApp.base_url = '/team4'" >> /root/.jupyter/jupyter_notebook_config.py

# Start Streamlit and Jupyter
CMD ["sh", "-c", "streamlit run app.py --server.port=5004 --server.address=0.0.0.0 & jupyter notebook --ip=0.0.0.0 --port=6004 --no-browser --allow-root"]
