...
print(f"Mistral Key: {MISTRAL_API_KEY}")
...
def query_rag(query):
    ...
    try:
        ...
        if not relevant_docs:
            return '''I regret to inform you that I could not find relevant context for your query. However, I am equipped to provide information related to <a href="https://dl.acm.org/doi/10.1145/3597503" style="color :black">  
