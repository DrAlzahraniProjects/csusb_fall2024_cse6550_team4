...
# Function to start Jupyter Notebook on port 6004
...
if __name__ == "__main__":
    ...
    try:
        ...
        if not api_key:
            raise ValueError("MISTRAL_API_KEY not found in environment variables. Please ensure it is set in the .env file.")
