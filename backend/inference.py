...
persist_directory = "faiss_indexes.bin"
#persist_directory = os.path.join(corpus_source, "faiss_indexes")

top_k = 15 # number of relevant documents to be returned
documents = load_documents_from_directory(corpus_source)
...
api_key = "wM7XpbcQVQNM73ZxKEPxojJdYOl9HwpM"
if not api_key:
