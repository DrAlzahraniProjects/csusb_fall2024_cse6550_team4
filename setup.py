...
def build_docker_image(mistral_key):
    ...
    run_command(f"docker build -t team4-app . --build-arg MISTRAL={mistral_key}", "Failed to build Docker image")
...
def run_docker_container():
    ...
    run_command(f"docker run -d -p 5004:5004 team4-app", "Failed to run Docker container")
    print("Docker container started successfully!")
    display_loading_bar(30)  # 30 seconds duration
    print("You can now access the application:")
    print("Website: http://localhost:5004/team4")
